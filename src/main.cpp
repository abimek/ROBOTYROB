...
void initialize() {
  ...
  chassis.opcontrol_curve_default_set(7.7, 0); // Defaults for curve. If using tank, only the first parameter is used. (Comment this line out if you have an SD card!)  
...
void opcontrol() {
  ...
  while (true) {
    ...
    bool wing2_toggle = master.get_digital_new_press(DIGITAL_R2) == 1;
    if(wing2_toggle){
      wing2_on = !wing2_on;
